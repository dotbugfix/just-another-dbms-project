...
connAdmin.Open ("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=.\db.mdb;Mode=ReadWrite;Persist Security Info=False")
...
If isnew = 1 Then
    ...
    'Remove admin
        ...
        rsAdmin.Open "select count(*) as num from administrator", connAdmin
        num = rsAdmin.Fields("NUM").Value
        rsAdmin.Close
        If num > 1 Then
            ...
            Unload Me
        Else
            MsgBox "You cannot remove the last administrator from the database!", vbCritical, "Admin Landing"
        End If
    Else
    'Update password
        rsAdmin.LockType = adLockOptimistic
