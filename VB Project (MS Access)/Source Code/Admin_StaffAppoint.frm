...
MsgBox "Use this function with care. The salary of each staff member contributes to the monthly expenses of the resort. Improper values may lead to an absurd financial report!", vbExclamation, "Demonstration"

adodcStaff.Recordset.AddNew
last_claim.Text = Format(Global_Module.Today, "dd-mmm-yyyy")
End Sub

Private Sub Gross_keypress(KeyAscii As Integer)
If KeyAscii < Asc("0") Or KeyAscii > Asc("9") Then
    If Not KeyAscii = 8 Then    'Allow Backspace
    KeyAscii = 0
    End If
