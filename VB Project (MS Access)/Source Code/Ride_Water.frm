...
OracleDB.RideList_Water

Set RideList.RowSource = OracleDB
RideList.RowMember = "RideList_Water"
...
Else
    ...
    varvalues = Array(VisitorID.Caption, RideList.Text, "water", Fee.Caption, Format(Global_Module.Today, "DD-MMM-YYYY"))
...
sqlquery = "select * from rides where type='water' and name='" & RideList.Text & "'"
