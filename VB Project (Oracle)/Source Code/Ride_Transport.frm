...
Begin VB.Form Ride_Transport 
   ...
   ClientWidth     =   11100
   LinkTopic       =   "Form1"
   Picture         =   "Ride_Transport.frx":0000
   ScaleHeight     =   7785
   ScaleWidth      =   11100
   ...
   End
End
Attribute VB_Name = "Ride_Transport"
...
OracleDB.RideList_Transport

Set RideList.RowSource = OracleDB
RideList.RowMember = "RideList_Transport"
...
Else
    ...
    varvalues = Array(VisitorID.Caption, RideList.Text, "transport", Fee.Caption, Format(Global_Module.Today, "DD-MMM-YYYY"))
...
sqlquery = "select * from rides where type='transport' and name='" & RideList.Text & "'"
