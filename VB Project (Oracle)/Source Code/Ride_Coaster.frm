...
Begin VB.Form Ride_Coaster 
   ...
   End
End
Attribute VB_Name = "Ride_Coaster"
...
OracleDB.RideList_Coaster

Set RideList.RowSource = OracleDB
RideList.RowMember = "RideList_Coaster"
...
sqlquery = "select * from rides where type='coaster' and name='" & RideList.Text & "'"
