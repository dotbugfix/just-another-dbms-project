VERSION 5.00
Begin VB.Form Admin_MonthlyFinance 
   ...
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Picture         =   "Admin_MonthlyFinance.frx":0000
   ScaleHeight     =   9915
   ScaleWidth      =   11535
   ...
   End
End
Attribute VB_Name = "Admin_MonthlyFinance"
...
Month.Caption = Admin_MonthlyFinanceLanding.MonthLIst.Text
Year.Caption = Admin_MonthlyFinanceLanding.YearBox.Text
