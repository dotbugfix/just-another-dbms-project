VERSION 5.00
Begin VB.Form Help_Request_old 
   ...
   ClientWidth     =   4140
   LinkTopic       =   "Form1"
   Picture         =   "Help_Request_old.frx":0000
   ScaleHeight     =   6225
   ScaleWidth      =   4140
   Begin VB.ComboBox HelpList 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "Help_Request_old.frx":4264
      Left            =   720
      List            =   "Help_Request_old.frx":4271
      TabIndex        =   1
      Text            =   "(select)"
      Top             =   2880
      Width           =   2775
   ...
   End
End
Attribute VB_Name = "Help_Request_old"
